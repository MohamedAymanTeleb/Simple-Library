...
export default function Ahmed({ books }) {
    ...
    return (
        <>
            ...
            <div className="container my-3" style={{
                ...
                <h2 className='p-1 bg-primary text-white text-center border rounded '>Ahmed Ayman</h2>
...
export async function getStaticProps(context) {
    const res = await fetch(`https://www.googleapis.com/books/v1/volumes?q=inauthor:"ahmed ayman"`)
